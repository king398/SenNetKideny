...
class CFG:
    ...
    # ============== model CFG =============
    model_name = 'Unet'
    backbone = 'tu-timm/seresnext101d_32x8d.ah_in1k'
...
root_path="/home/mithil/PycharmProjects/SenNetKideny/data/"
parhs=["/home/mithil/PycharmProjects/SenNetKideny/data/train/kidney_1_dense"]
for i,path in enumerate(parhs):
    if path=="/home/mithil/PycharmProjects/SenNetKideny/data/train/kidney_3_dense":
        continue
...
path1="/home/mithil/PycharmProjects/SenNetKideny/data/train/kidney_3_sparse"
path2="/home/mithil/PycharmProjects/SenNetKideny/data/train/kidney_3_dense"
...
train_dataset = DataLoader(train_dataset, batch_size=CFG.train_batch_size ,num_workers=8, shuffle=True, pin_memory=True)
val_dataset=Kaggld_Dataset([val_x],[val_y])
val_dataset = DataLoader(val_dataset, batch_size=CFG.valid_batch_size, num_workers=8, shuffle=False, pin_memory=True)
...
for epoch in range(CFG.epochs):
    ...
    time.close()
tc.save(model.state_dict(),f"{epoch}_loss{losss:.2f}_score{scores:.2f}_val_loss{val_losss:.2f}_val_score{val_scores:.2f}_midd_rot002.pt")
