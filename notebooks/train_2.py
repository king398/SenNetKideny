...
class CFG:
    ...
    # ============== model CFG =============
    model_name = 'Unet'
    backbone = 'tu-timm/maxvit_small_tf_512.in1k'
...
tc.save(model.state_dict(),
        f"maxvit_{epoch}_loss{losss:.2f}_score{scores:.2f}_val_loss{val_losss:.2f}_val_score{val_scores:.2f}_midd_rot002.pt")
